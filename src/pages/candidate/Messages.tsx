  ...
  return (
    <div className="p-4 sm:p-6 max-w-2xl mx-auto">
      <div className="mb-5">
        ...
        <p className="text-sm text-gray-500">Direct messages from employers and ATS Corps</p>
      </div>
      ...
      >
        ...
        <p className="text-xs text-gray-400 max-w-xs mx-auto leading-relaxed">
          When employers or ATS Corps coordinators message you, conversations will appear here.
        </p>
      </motion.div>
      ...
      <div className="mt-4 bg-blue-50 border border-blue-100 rounded-2xl p-4">
        <div className="flex items-start gap-3">
          ...
          <p className="text-xs text-blue-800 leading-relaxed">
            <span className="font-bold">Messaging coming soon.</span> You will be able to communicate directly with
            recruiters and receive interview invites through this portal. Until then, ATS Corps will contact you
