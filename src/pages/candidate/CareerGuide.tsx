...
import {
  BookOpen, Shield, FileText, Briefcase, CheckCircle, Star, Users, Phone,
} from 'lucide-react'
  ...
  return (
    <div className="p-4 sm:p-6 max-w-2xl mx-auto">
      <div className="mb-5">
        ...
        <p className="text-sm text-gray-500">Tips and resources for ex-servicemen transitioning to civilian work</p>
      </div>
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-bold text-sm" style={{ fontFamily: 'Plus Jakarta Sans' }}>Welcome, Warrior to Workforce</p>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              ...
              ATS Corps coordinators are also available to assist — reach out through your registered mobile number.
            </p>
          </div>
        </div>
      </motion.div>
