      ...
      >
        <div className='flex items-start justify-between gap-4'>
          <div>
            ...
            >
              Ex-Serviceman Jobs Control Panel
            </h1>
            <p className='text-xs text-gray-400 mt-1'>
              Monitor all companies, candidates, and job activity.
            </p>
          </div>
            ...
            {loading ? (
              ...
              <div className='space-y-2.5'>
                {stats.byForce.map((f) => (
                  ...
                  >
                    <span
                      className={`inline-flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded-full ${FORCE_COLOR[f.force] ?? 'bg-gray-100 text-gray-600'}`}
                    >
